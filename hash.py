...
"""
__Author__ = KENZO CAKEP
__Name__ = hasher
__version__ = 3.0.1 (alpha)
__Code__ = python
__Github__ = https://github.com/okokanaja
__Date__ = 03 - 12 - 2020
__Team__ = GARUDA CYBER WHITE HAT
...
def banner():
	...
	print (G+'  ------------------------------------------')
	print (R+'  db   db  .d8b.  .d8888. db   db d88888b d8888b. ')
	print (R+'  88   88 d8' `8b 88'  YP 88   88 88'     88  `8D ')
	print (R+'  88ooo88 88ooo88 `8bo.   88ooo88 88ooooo 88oobY'  ')
	print (W+'  88~~~88 88~~~88   `Y8b. 88~~~88 88~~~~~ 88`8b ')
    print (W+'  88   88 88   88 db   8D 88   88 88.     88 `88. ')
	print (W+'  YP   YP YP   YP `8888Y' YP   YP Y88888P 88   YD ')
	print (G+'  ------------------------------------------')
...
def info():
	...
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Author   "+C+":"+W+" okokanaja "+R+"a.k.a "+W+"KENZO CAKEP"+Y+"                 |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Email    "+C+":"+W+" XnVer404@gmail.com"+Y+"                   |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Github   "+C+":"+W+" https://github.com/okokanaja"+Y+"           |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Date     "+C+":"+W+" 03 - 12 - 2020"+Y+"                       |")
	print (Y+" |"+B+" ["+R+"="+B+"] "+W+"Team     "+C+":"+W+" GARUDA CYBER WHITE HAT"+Y+"                   |")
	print (Y+" 0{===================================================}0\n")
